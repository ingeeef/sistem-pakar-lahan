                ...
                <div class="container px-5 my-5">
                    ...
                    <div class="row gx-5 row-cols-1 row-cols-sm-2 row-cols-xl-4 justify-content-center">
                        <div class="col mb-5 mb-5 mb-xl-0">
                            <div class="text-center">
                                <img class="img-fluid rounded-circle mb-4 px-4" src="d.jpg" alt="..." />
                                <h5 class="fw-bolder">Ahmad Dandi Irawan</h5>
                                <div class="fst-italic text-muted">Pengembang Web</div>
                            </div>
                        </div>
                        <div class="col mb-5 mb-5 mb-xl-0">
                            <div class="text-center">
                                <img class="img-fluid rounded-circle mb-4 px-4" src="dosen.jpg" alt="..." />
                                <h5 class="fw-bolder">Zilvanhisna Emka Fitri, ST. MT</h5>
                                <div class="fst-italic text-muted">Dosen Pembimbing</div>
                            </div>
                        </div>
